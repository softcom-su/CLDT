 ...
 *	$Id: xdr.h,v 1.1.1.1 2004/05/11 13:36:46 nkigor Exp $
 */
...
typedef struct {
	...
	struct xdr_ops {
		...
		int32_t *	(*x_inline)();	/* buf quick ptr to buffered data */
...
extern bool_t	xdr_long	__P((XDR *, int32_t *));
extern bool_t	xdr_u_long	__P((XDR *, uint32_t *));
...
extern bool_t xdr_int64(register XDR *, int64_t *) ;
__END_DECLS
