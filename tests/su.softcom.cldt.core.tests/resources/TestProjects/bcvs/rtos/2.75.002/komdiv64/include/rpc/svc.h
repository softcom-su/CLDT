 ...
 *	$Id: svc.h,v 1.1.1.1 2004/05/11 13:36:46 nkigor Exp $
 */
 ...
 */
__BEGIN_DECLS
extern bool_t	svc_register __P((SVCXPRT *, uint32_t, uint32_t, void (*)(), int));
__END_DECLS
 ...
 */
__BEGIN_DECLS
extern void	svc_unregister __P((uint32_t, uint32_t));
__END_DECLS
...
extern void	svcerr_progvers	__P((SVCXPRT *, uint32_t, uint32_t));
