// Файл "rint.h" содержит inline функцию математической библиотеки double rint( double x ).
...
// Описание:
//    rint() - функция для округления аргумента до ближайшего целого числа типа double,
...
#if( !defined( __MATH_INLINE_RINT_H__ ))
#define __MATH_INLINE_RINT_H__

#ifdef BT_MATH_INLINE
#define rint MATH_INLINE_RINT
#endif

#include <math_inline/fabs.h>

static double __inline__ __UNUSED_F MATH_INLINE_RINT( double x )
{
