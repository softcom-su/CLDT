...
set wd [create_dialog $w 9 0 __BOARD_CONFIG 0 0 0 0]
dialog___BOARD_CONFIG_0 $wd.top
create_int $wd.top 12 2 BOARD_TIMER_HZ -1 10
}
# dialog___BOARD_CONFIG end
proc dialog___BOARD_CONFIG_0 { w } {
set wd [create_dialog $w 11 0 __BOARD_CONFIG_0 0 1 1 2]
...
create_bool $wd.top 7 "INCLUDE_BTM401" -1 6 2
create_bool $wd.top 8 "INCLUDE_VSK" -1 7 2
create_bool $wd.top 9 "INCLUDE_SCSI" -1 8 2
create_bool $wd.top 10 "INCLUDE_IDE" -1 9 2
create_bool $wd.top 11 "INCLUDE_RIO" -1 10 2
}
# dialog___BOARD_CONFIG_0 end
proc dialog___AUX { w } {
set wd [create_dialog $w 2 0 __AUX 0 13 0 0]
}
# dialog___AUX end
proc dialog_AUX_CONFIG { w } {
global current_line thl; set current_line 0 
set wd [create_dialog $w 6 2 AUX_CONFIG 1 14 0 0]
set m [create_menu $wd.top 15 1 AUX_NAME 0 1]
set m [create_menu $wd.top 16 2 AUX_RBUF 1 1]
set m [create_menu $wd.top 17 3 AUX_WBUF 2 1]
set m [create_menu $wd.top 18 4 AUX_SPEED 3 1]
set m [create_menu $wd.top 19 5 AUX_INT_ENABLE 4 0]
...
set wd [create_dialog $w 3 0 __DE_CONFIG 1 20 0 0]
dialog_DE0_INCLUDE $wd.top
dialog_DE1_INCLUDE $wd.top
}
# dialog___DE_CONFIG end
proc dialog_DE0_INCLUDE { w } {
set wd [create_dialog $w 8 0 DE0_INCLUDE 0 21 1 0]
set m [create_menu $wd.top 22 1 DE0_CSR11 -1 0]
set m [create_menu $wd.top 23 2 DE0_TTM -1 0]
create_bool $wd.top 24 "DE0_10HD" -1 3 0
create_bool $wd.top 25 "DE0_10FD" -1 4 0
create_bool $wd.top 26 "DE0_100HD" -1 5 0
create_bool $wd.top 27 "DE0_100FD" -1 6 0
create_bool $wd.top 28 "DE0_RESET" -1 7 0
}
# dialog_DE0_INCLUDE end
proc dialog_DE1_INCLUDE { w } {
set wd [create_dialog $w 8 0 DE1_INCLUDE 1 29 1 0]
set m [create_menu $wd.top 30 1 DE1_CSR11 -1 0]
set m [create_menu $wd.top 31 2 DE1_TTM -1 0]
create_bool $wd.top 32 "DE1_10HD" -1 3 0
create_bool $wd.top 33 "DE1_10FD" -1 4 0
create_bool $wd.top 34 "DE1_100HD" -1 5 0
create_bool $wd.top 35 "DE1_100FD" -1 6 0
create_bool $wd.top 36 "DE1_RESET" -1 7 0
}
# dialog_DE1_INCLUDE end
proc dialog___RGB_CONFIG { w } {
set wd [create_dialog $w 11 0 __RGB_CONFIG 1 37 0 0]
set m [create_menu $wd.top 38 1 COLOR_FG -1 0]
set m [create_menu $wd.top 39 2 COLOR_BG -1 0]
create_int $wd.top 40 3 TAB_SIZE -1 10
create_int $wd.top 41 4 RGB_MQ_DEPTH -1 10
create_int $wd.top 42 5 RGB_THREAD_PRI -1 10
create_bool $wd.top 43 "RGB_INHERIT_MODE" -1 6 0
create_bool $wd.top 44 "RGB_CURSOR_BLINK" -1 7 0
create_bool $wd.top 45 "RGB_FLAT_PANEL" -1 8 0
set m [create_menu $wd.top 46 9 RGB_MODE -1 0]
set m [create_menu $wd.top 47 10 FP_MODE -1 0]
}
# dialog___RGB_CONFIG end
proc dialog___IDE_CONFIG { w } {
set wd [create_dialog $w 3 0 __IDE_CONFIG 1 48 0 0]
dialog___IDE_CONFIG1 $wd.top
}
# dialog___IDE_CONFIG end
proc dialog___IDE_CONFIG1 { w } {
set wd [create_dialog $w 5 0 __IDE_CONFIG1 0 49 1 0]
create_bool $wd.top 50 "IDE_RESET" -1 1 0
create_bool $wd.top 51 "IDE_SLOW_IO" -1 2 0
set m [create_menu $wd.top 52 3 IDE_PRI -1 1]
dialog_IDE_PARAMS $wd.top
}
# dialog___IDE_CONFIG1 end
proc dialog_IDE_PARAMS { w } {
global current_line thl; set current_line 0 
set wd [create_dialog $w 7 4 IDE_PARAMS 1 53 1 0]
set m [create_menu $wd.top 54 1 IDE_NAME 0 1]
set m [create_menu $wd.top 55 2 IDE_CTRL 1 0]
set m [create_menu $wd.top 56 3 IDE_CHANNEL 2 0]
set m [create_menu $wd.top 57 4 IDE_DRIVE 3 0]
set m [create_menu $wd.top 58 5 IDE_DMA 4 0]
create_bool $wd.top 59 "IDE_MBR" 5 6 0
...
set wd [create_dialog $w 3 0 __INCLUDE_BTM405_IDE 1 60 0 0]
dialog___BTM405_IDE0 $wd.top
dialog___BTM405_IDE1 $wd.top
}
# dialog___INCLUDE_BTM405_IDE end
proc dialog___BTM405_IDE0 { w } {
set wd [create_dialog $w 5 0 __BTM405_IDE0 0 61 1 0]
set m [create_menu $wd.top 62 1 BTM405_CTRL0_CH0_PIO -1 1]
set m [create_menu $wd.top 63 2 BTM405_CTRL0_CH0_DMA -1 1]
set m [create_menu $wd.top 64 3 BTM405_CTRL0_CH1_PIO -1 1]
set m [create_menu $wd.top 65 4 BTM405_CTRL0_CH1_DMA -1 1]
}
# dialog___BTM405_IDE0 end
proc dialog___BTM405_IDE1 { w } {
set wd [create_dialog $w 5 0 __BTM405_IDE1 0 66 1 0]
set m [create_menu $wd.top 67 1 BTM405_CTRL1_CH0_PIO -1 1]
set m [create_menu $wd.top 68 2 BTM405_CTRL1_CH0_DMA -1 1]
set m [create_menu $wd.top 69 3 BTM405_CTRL1_CH1_PIO -1 1]
set m [create_menu $wd.top 70 4 BTM405_CTRL1_CH1_DMA -1 1]
}
# dialog___BTM405_IDE1 end
proc dialog___BSP_MISC { w } {
set wd [create_dialog $w 3 0 __BSP_MISC 0 71 0 0]
dialog___BSP_MISC1 $wd.top
dialog___CRC_ERROR $wd.top
}
# dialog___BSP_MISC end
proc dialog___BSP_MISC1 { w } {
set wd [create_dialog $w 8 0 __BSP_MISC1 0 72 1 0]
create_bool $wd.top 73 "INCLUDE_LOGGING" -1 1 0
create_int $wd.top 74 2 LOG_MSG_MAX -1 10
create_bool $wd.top 75 "BAD_INTS_LOGGING" -1 3 0
set m [create_menu $wd.top 76 4 WARM_REBOOT -1 1]
create_bool $wd.top 77 "INCLUDE_IDLE" -1 5 0
create_int $wd.top 78 6 IDLE_PRIORITY -1 10
create_int $wd.top 79 7 IDLE_DELAY -1 10
}
# dialog___BSP_MISC1 end
proc dialog___CRC_ERROR { w } {
set wd [create_dialog $w 4 0 __CRC_ERROR 0 80 1 0]
set m [create_menu $wd.top 81 1 CRC_ERROR_BEHAVIOR -1 0]
set m [create_menu $wd.top 82 2 CRC_REBOOT_ENTRY -1 1]
set m [create_menu $wd.top 83 3 CRC_NVRAM_ADDRESS -1 1]
}
# dialog___CRC_ERROR end
proc dialog__RIO_CONFIG { w } {
set wd [create_dialog $w 8 0 _RIO_CONFIG 0 84 0 0]
create_int $wd.top 85 1 RIO_SEND_THR_PRIORITY -1 10
create_int $wd.top 86 2 RIO_TIMEOUT -1 10
dialog_INCLUDE_RREG $wd.top
create_int $wd.top 344 4 RREG_TIMEOUT -1 10
create_int $wd.top 345 5 RREG_THREAD_PRI -1 10
create_int $wd.top 346 6 RREG_ID_MAX -1 10
dialog_INCLUDE_RMSG_NET $wd.top
}
# dialog__RIO_CONFIG end
proc dialog_INCLUDE_RREG { w } {
set wd [create_dialog $w 257 0 INCLUDE_RREG 1 87 1 16]
create_bool $wd.top 88 "RREG_ID00" -1 1 16
create_bool $wd.top 89 "RREG_ID01" -1 2 16
create_bool $wd.top 90 "RREG_ID02" -1 3 16
create_bool $wd.top 91 "RREG_ID03" -1 4 16
create_bool $wd.top 92 "RREG_ID04" -1 5 16
create_bool $wd.top 93 "RREG_ID05" -1 6 16
create_bool $wd.top 94 "RREG_ID06" -1 7 16
create_bool $wd.top 95 "RREG_ID07" -1 8 16
create_bool $wd.top 96 "RREG_ID08" -1 9 16
create_bool $wd.top 97 "RREG_ID09" -1 10 16
create_bool $wd.top 98 "RREG_ID0A" -1 11 16
create_bool $wd.top 99 "RREG_ID0B" -1 12 16
create_bool $wd.top 100 "RREG_ID0C" -1 13 16
create_bool $wd.top 101 "RREG_ID0D" -1 14 16
create_bool $wd.top 102 "RREG_ID0E" -1 15 16
create_bool $wd.top 103 "RREG_ID0F" -1 16 16
create_bool $wd.top 104 "RREG_ID10" -1 17 16
create_bool $wd.top 105 "RREG_ID11" -1 18 16
create_bool $wd.top 106 "RREG_ID12" -1 19 16
create_bool $wd.top 107 "RREG_ID13" -1 20 16
create_bool $wd.top 108 "RREG_ID14" -1 21 16
create_bool $wd.top 109 "RREG_ID15" -1 22 16
create_bool $wd.top 110 "RREG_ID16" -1 23 16
create_bool $wd.top 111 "RREG_ID17" -1 24 16
create_bool $wd.top 112 "RREG_ID18" -1 25 16
create_bool $wd.top 113 "RREG_ID19" -1 26 16
create_bool $wd.top 114 "RREG_ID1A" -1 27 16
create_bool $wd.top 115 "RREG_ID1B" -1 28 16
create_bool $wd.top 116 "RREG_ID1C" -1 29 16
create_bool $wd.top 117 "RREG_ID1D" -1 30 16
create_bool $wd.top 118 "RREG_ID1E" -1 31 16
create_bool $wd.top 119 "RREG_ID1F" -1 32 16
create_bool $wd.top 120 "RREG_ID20" -1 33 16
create_bool $wd.top 121 "RREG_ID21" -1 34 16
create_bool $wd.top 122 "RREG_ID22" -1 35 16
create_bool $wd.top 123 "RREG_ID23" -1 36 16
create_bool $wd.top 124 "RREG_ID24" -1 37 16
create_bool $wd.top 125 "RREG_ID25" -1 38 16
create_bool $wd.top 126 "RREG_ID26" -1 39 16
create_bool $wd.top 127 "RREG_ID27" -1 40 16
create_bool $wd.top 128 "RREG_ID28" -1 41 16
create_bool $wd.top 129 "RREG_ID29" -1 42 16
create_bool $wd.top 130 "RREG_ID2A" -1 43 16
create_bool $wd.top 131 "RREG_ID2B" -1 44 16
create_bool $wd.top 132 "RREG_ID2C" -1 45 16
create_bool $wd.top 133 "RREG_ID2D" -1 46 16
create_bool $wd.top 134 "RREG_ID2E" -1 47 16
create_bool $wd.top 135 "RREG_ID2F" -1 48 16
create_bool $wd.top 136 "RREG_ID30" -1 49 16
create_bool $wd.top 137 "RREG_ID31" -1 50 16
create_bool $wd.top 138 "RREG_ID32" -1 51 16
create_bool $wd.top 139 "RREG_ID33" -1 52 16
create_bool $wd.top 140 "RREG_ID34" -1 53 16
create_bool $wd.top 141 "RREG_ID35" -1 54 16
create_bool $wd.top 142 "RREG_ID36" -1 55 16
create_bool $wd.top 143 "RREG_ID37" -1 56 16
create_bool $wd.top 144 "RREG_ID38" -1 57 16
create_bool $wd.top 145 "RREG_ID39" -1 58 16
create_bool $wd.top 146 "RREG_ID3A" -1 59 16
create_bool $wd.top 147 "RREG_ID3B" -1 60 16
create_bool $wd.top 148 "RREG_ID3C" -1 61 16
create_bool $wd.top 149 "RREG_ID3D" -1 62 16
create_bool $wd.top 150 "RREG_ID3E" -1 63 16
create_bool $wd.top 151 "RREG_ID3F" -1 64 16
create_bool $wd.top 152 "RREG_ID40" -1 65 16
create_bool $wd.top 153 "RREG_ID41" -1 66 16
create_bool $wd.top 154 "RREG_ID42" -1 67 16
create_bool $wd.top 155 "RREG_ID43" -1 68 16
create_bool $wd.top 156 "RREG_ID44" -1 69 16
create_bool $wd.top 157 "RREG_ID45" -1 70 16
create_bool $wd.top 158 "RREG_ID46" -1 71 16
create_bool $wd.top 159 "RREG_ID47" -1 72 16
create_bool $wd.top 160 "RREG_ID48" -1 73 16
create_bool $wd.top 161 "RREG_ID49" -1 74 16
create_bool $wd.top 162 "RREG_ID4A" -1 75 16
create_bool $wd.top 163 "RREG_ID4B" -1 76 16
create_bool $wd.top 164 "RREG_ID4C" -1 77 16
create_bool $wd.top 165 "RREG_ID4D" -1 78 16
create_bool $wd.top 166 "RREG_ID4E" -1 79 16
create_bool $wd.top 167 "RREG_ID4F" -1 80 16
create_bool $wd.top 168 "RREG_ID50" -1 81 16
create_bool $wd.top 169 "RREG_ID51" -1 82 16
create_bool $wd.top 170 "RREG_ID52" -1 83 16
create_bool $wd.top 171 "RREG_ID53" -1 84 16
create_bool $wd.top 172 "RREG_ID54" -1 85 16
create_bool $wd.top 173 "RREG_ID55" -1 86 16
create_bool $wd.top 174 "RREG_ID56" -1 87 16
create_bool $wd.top 175 "RREG_ID57" -1 88 16
create_bool $wd.top 176 "RREG_ID58" -1 89 16
create_bool $wd.top 177 "RREG_ID59" -1 90 16
create_bool $wd.top 178 "RREG_ID5A" -1 91 16
create_bool $wd.top 179 "RREG_ID5B" -1 92 16
create_bool $wd.top 180 "RREG_ID5C" -1 93 16
create_bool $wd.top 181 "RREG_ID5D" -1 94 16
create_bool $wd.top 182 "RREG_ID5E" -1 95 16
create_bool $wd.top 183 "RREG_ID5F" -1 96 16
create_bool $wd.top 184 "RREG_ID60" -1 97 16
create_bool $wd.top 185 "RREG_ID61" -1 98 16
create_bool $wd.top 186 "RREG_ID62" -1 99 16
create_bool $wd.top 187 "RREG_ID63" -1 100 16
create_bool $wd.top 188 "RREG_ID64" -1 101 16
create_bool $wd.top 189 "RREG_ID65" -1 102 16
create_bool $wd.top 190 "RREG_ID66" -1 103 16
create_bool $wd.top 191 "RREG_ID67" -1 104 16
create_bool $wd.top 192 "RREG_ID68" -1 105 16
create_bool $wd.top 193 "RREG_ID69" -1 106 16
create_bool $wd.top 194 "RREG_ID6A" -1 107 16
create_bool $wd.top 195 "RREG_ID6B" -1 108 16
create_bool $wd.top 196 "RREG_ID6C" -1 109 16
create_bool $wd.top 197 "RREG_ID6D" -1 110 16
create_bool $wd.top 198 "RREG_ID6E" -1 111 16
create_bool $wd.top 199 "RREG_ID6F" -1 112 16
create_bool $wd.top 200 "RREG_ID70" -1 113 16
create_bool $wd.top 201 "RREG_ID71" -1 114 16
create_bool $wd.top 202 "RREG_ID72" -1 115 16
create_bool $wd.top 203 "RREG_ID73" -1 116 16
create_bool $wd.top 204 "RREG_ID74" -1 117 16
create_bool $wd.top 205 "RREG_ID75" -1 118 16
create_bool $wd.top 206 "RREG_ID76" -1 119 16
create_bool $wd.top 207 "RREG_ID77" -1 120 16
create_bool $wd.top 208 "RREG_ID78" -1 121 16
create_bool $wd.top 209 "RREG_ID79" -1 122 16
create_bool $wd.top 210 "RREG_ID7A" -1 123 16
create_bool $wd.top 211 "RREG_ID7B" -1 124 16
create_bool $wd.top 212 "RREG_ID7C" -1 125 16
create_bool $wd.top 213 "RREG_ID7D" -1 126 16
create_bool $wd.top 214 "RREG_ID7E" -1 127 16
create_bool $wd.top 215 "RREG_ID7F" -1 128 16
create_bool $wd.top 216 "RREG_ID80" -1 129 16
create_bool $wd.top 217 "RREG_ID81" -1 130 16
create_bool $wd.top 218 "RREG_ID82" -1 131 16
create_bool $wd.top 219 "RREG_ID83" -1 132 16
create_bool $wd.top 220 "RREG_ID84" -1 133 16
create_bool $wd.top 221 "RREG_ID85" -1 134 16
create_bool $wd.top 222 "RREG_ID86" -1 135 16
create_bool $wd.top 223 "RREG_ID87" -1 136 16
create_bool $wd.top 224 "RREG_ID88" -1 137 16
create_bool $wd.top 225 "RREG_ID89" -1 138 16
create_bool $wd.top 226 "RREG_ID8A" -1 139 16
create_bool $wd.top 227 "RREG_ID8B" -1 140 16
create_bool $wd.top 228 "RREG_ID8C" -1 141 16
create_bool $wd.top 229 "RREG_ID8D" -1 142 16
create_bool $wd.top 230 "RREG_ID8E" -1 143 16
create_bool $wd.top 231 "RREG_ID8F" -1 144 16
create_bool $wd.top 232 "RREG_ID90" -1 145 16
create_bool $wd.top 233 "RREG_ID91" -1 146 16
create_bool $wd.top 234 "RREG_ID92" -1 147 16
create_bool $wd.top 235 "RREG_ID93" -1 148 16
create_bool $wd.top 236 "RREG_ID94" -1 149 16
create_bool $wd.top 237 "RREG_ID95" -1 150 16
create_bool $wd.top 238 "RREG_ID96" -1 151 16
create_bool $wd.top 239 "RREG_ID97" -1 152 16
create_bool $wd.top 240 "RREG_ID98" -1 153 16
create_bool $wd.top 241 "RREG_ID99" -1 154 16
create_bool $wd.top 242 "RREG_ID9A" -1 155 16
create_bool $wd.top 243 "RREG_ID9B" -1 156 16
create_bool $wd.top 244 "RREG_ID9C" -1 157 16
create_bool $wd.top 245 "RREG_ID9D" -1 158 16
create_bool $wd.top 246 "RREG_ID9E" -1 159 16
create_bool $wd.top 247 "RREG_ID9F" -1 160 16
create_bool $wd.top 248 "RREG_IDA0" -1 161 16
create_bool $wd.top 249 "RREG_IDA1" -1 162 16
create_bool $wd.top 250 "RREG_IDA2" -1 163 16
create_bool $wd.top 251 "RREG_IDA3" -1 164 16
create_bool $wd.top 252 "RREG_IDA4" -1 165 16
create_bool $wd.top 253 "RREG_IDA5" -1 166 16
create_bool $wd.top 254 "RREG_IDA6" -1 167 16
create_bool $wd.top 255 "RREG_IDA7" -1 168 16
create_bool $wd.top 256 "RREG_IDA8" -1 169 16
create_bool $wd.top 257 "RREG_IDA9" -1 170 16
create_bool $wd.top 258 "RREG_IDAA" -1 171 16
create_bool $wd.top 259 "RREG_IDAB" -1 172 16
create_bool $wd.top 260 "RREG_IDAC" -1 173 16
create_bool $wd.top 261 "RREG_IDAD" -1 174 16
create_bool $wd.top 262 "RREG_IDAE" -1 175 16
create_bool $wd.top 263 "RREG_IDAF" -1 176 16
create_bool $wd.top 264 "RREG_IDB0" -1 177 16
create_bool $wd.top 265 "RREG_IDB1" -1 178 16
create_bool $wd.top 266 "RREG_IDB2" -1 179 16
create_bool $wd.top 267 "RREG_IDB3" -1 180 16
create_bool $wd.top 268 "RREG_IDB4" -1 181 16
create_bool $wd.top 269 "RREG_IDB5" -1 182 16
create_bool $wd.top 270 "RREG_IDB6" -1 183 16
create_bool $wd.top 271 "RREG_IDB7" -1 184 16
create_bool $wd.top 272 "RREG_IDB8" -1 185 16
create_bool $wd.top 273 "RREG_IDB9" -1 186 16
create_bool $wd.top 274 "RREG_IDBA" -1 187 16
create_bool $wd.top 275 "RREG_IDBB" -1 188 16
create_bool $wd.top 276 "RREG_IDBC" -1 189 16
create_bool $wd.top 277 "RREG_IDBD" -1 190 16
create_bool $wd.top 278 "RREG_IDBE" -1 191 16
create_bool $wd.top 279 "RREG_IDBF" -1 192 16
create_bool $wd.top 280 "RREG_IDC0" -1 193 16
create_bool $wd.top 281 "RREG_IDC1" -1 194 16
create_bool $wd.top 282 "RREG_IDC2" -1 195 16
create_bool $wd.top 283 "RREG_IDC3" -1 196 16
create_bool $wd.top 284 "RREG_IDC4" -1 197 16
create_bool $wd.top 285 "RREG_IDC5" -1 198 16
create_bool $wd.top 286 "RREG_IDC6" -1 199 16
create_bool $wd.top 287 "RREG_IDC7" -1 200 16
create_bool $wd.top 288 "RREG_IDC8" -1 201 16
create_bool $wd.top 289 "RREG_IDC9" -1 202 16
create_bool $wd.top 290 "RREG_IDCA" -1 203 16
create_bool $wd.top 291 "RREG_IDCB" -1 204 16
create_bool $wd.top 292 "RREG_IDCC" -1 205 16
create_bool $wd.top 293 "RREG_IDCD" -1 206 16
create_bool $wd.top 294 "RREG_IDCE" -1 207 16
create_bool $wd.top 295 "RREG_IDCF" -1 208 16
create_bool $wd.top 296 "RREG_IDD0" -1 209 16
create_bool $wd.top 297 "RREG_IDD1" -1 210 16
create_bool $wd.top 298 "RREG_IDD2" -1 211 16
create_bool $wd.top 299 "RREG_IDD3" -1 212 16
create_bool $wd.top 300 "RREG_IDD4" -1 213 16
create_bool $wd.top 301 "RREG_IDD5" -1 214 16
create_bool $wd.top 302 "RREG_IDD6" -1 215 16
create_bool $wd.top 303 "RREG_IDD7" -1 216 16
create_bool $wd.top 304 "RREG_IDD8" -1 217 16
create_bool $wd.top 305 "RREG_IDD9" -1 218 16
create_bool $wd.top 306 "RREG_IDDA" -1 219 16
create_bool $wd.top 307 "RREG_IDDB" -1 220 16
create_bool $wd.top 308 "RREG_IDDC" -1 221 16
create_bool $wd.top 309 "RREG_IDDD" -1 222 16
create_bool $wd.top 310 "RREG_IDDE" -1 223 16
create_bool $wd.top 311 "RREG_IDDF" -1 224 16
create_bool $wd.top 312 "RREG_IDE0" -1 225 16
create_bool $wd.top 313 "RREG_IDE1" -1 226 16
create_bool $wd.top 314 "RREG_IDE2" -1 227 16
create_bool $wd.top 315 "RREG_IDE3" -1 228 16
create_bool $wd.top 316 "RREG_IDE4" -1 229 16
create_bool $wd.top 317 "RREG_IDE5" -1 230 16
create_bool $wd.top 318 "RREG_IDE6" -1 231 16
create_bool $wd.top 319 "RREG_IDE7" -1 232 16
create_bool $wd.top 320 "RREG_IDE8" -1 233 16
create_bool $wd.top 321 "RREG_IDE9" -1 234 16
create_bool $wd.top 322 "RREG_IDEA" -1 235 16
create_bool $wd.top 323 "RREG_IDEB" -1 236 16
create_bool $wd.top 324 "RREG_IDEC" -1 237 16
create_bool $wd.top 325 "RREG_IDED" -1 238 16
create_bool $wd.top 326 "RREG_IDEE" -1 239 16
create_bool $wd.top 327 "RREG_IDEF" -1 240 16
create_bool $wd.top 328 "RREG_IDF0" -1 241 16
create_bool $wd.top 329 "RREG_IDF1" -1 242 16
create_bool $wd.top 330 "RREG_IDF2" -1 243 16
create_bool $wd.top 331 "RREG_IDF3" -1 244 16
create_bool $wd.top 332 "RREG_IDF4" -1 245 16
create_bool $wd.top 333 "RREG_IDF5" -1 246 16
create_bool $wd.top 334 "RREG_IDF6" -1 247 16
create_bool $wd.top 335 "RREG_IDF7" -1 248 16
create_bool $wd.top 336 "RREG_IDF8" -1 249 16
create_bool $wd.top 337 "RREG_IDF9" -1 250 16
create_bool $wd.top 338 "RREG_IDFA" -1 251 16
create_bool $wd.top 339 "RREG_IDFB" -1 252 16
create_bool $wd.top 340 "RREG_IDFC" -1 253 16
create_bool $wd.top 341 "RREG_IDFD" -1 254 16
create_bool $wd.top 342 "RREG_IDFE" -1 255 16
create_bool $wd.top 343 "RREG_IDFF" -1 256 16
}
# dialog_INCLUDE_RREG end
proc dialog_INCLUDE_RMSG_NET { w } {
set wd [create_dialog $w 2 0 INCLUDE_RMSG_NET 1 347 1 0]
create_int $wd.top 348 1 RMSG_NET_RX_BUF_SIZE -1 10
}
...
addvar INCLUDE_BTM401$i $i {x_configbrd.h} u  "0" 5 {} {} {} {} {Include driver for PMC Manchester interface} {} {} {} {PMC Manchester} __BOARD_CONFIG.__BOARD_CONFIG_0.INCLUDE_BTM401 {} 0 bool
addvar INCLUDE_VSK$i $i {x_configbrd.h} u  "0" 6 {} {} {} {} {Include driver for VSK source data input (from libvsk-kernel.a)} {} {} {} {VSK} __BOARD_CONFIG.__BOARD_CONFIG_0.INCLUDE_VSK {} 0 bool
addvar INCLUDE_SCSI$i $i {x_configbrd.h} u  "0" 7 {} {} {} {} {Include driver for SCSI hard disk} {} {} {} {SCSI} __BOARD_CONFIG.__BOARD_CONFIG_0.INCLUDE_SCSI {} 0 bool
addvar INCLUDE_IDE$i $i {x_configbrd.h} u  "0" 8 {} {__IDE_CONFIG IDE_RESET IDE_SLOW_IO IDE_PRI IDE_PARAMS __INCLUDE_BTM405_IDE __BTM405_IDE0 BTM405_CTRL0_CH0_PIO BTM405_CTRL0_CH0_DMA BTM405_CTRL0_CH1_PIO BTM405_CTRL0_CH1_DMA __BTM405_IDE1 BTM405_CTRL1_CH0_PIO BTM405_CTRL1_CH0_DMA BTM405_CTRL1_CH1_PIO BTM405_CTRL1_CH1_DMA } {} {} {Include driver for IDE hard disk} {} {} {} {IDE} __BOARD_CONFIG.__BOARD_CONFIG_0.INCLUDE_IDE {} 0 bool
addvar INCLUDE_RIO$i $i {x_configbrd.h} u  "1" 9 {[set RIO_CONFIG $INCLUDE_RIO]+1} {_RIO_CONFIG INCLUDE_RREG } {} {} {Include driver for RapidIO} {} {} {} {RapidIO} __BOARD_CONFIG.__BOARD_CONFIG_0.INCLUDE_RIO {} 0 bool
...
addvar __BSP_MISC$i $i {x_configbrd.h} u  "1" 6 {} {} {} {} {} {} {} {} {Miscellaneous} __BOARD_CONFIG.__BSP_MISC {} 0 bool
...
addvar _RIO_CONFIG$i $i {x_configbrd.h} u  "1" 7 {$INCLUDE_RIO==1} {} {} {} {} {} {} {} {Rapid IO Configuration} __BOARD_CONFIG._RIO_CONFIG {} 0 bool
...
addvar RMSG_NET_RX_BUF_SIZE$i $i {x_configbrd.h} x  "0x0" 0 {} {} {} {} {Size of receive network buffer in bytes. Set to 0 for default value} {} {} {} {Size of receive network buffer} __BOARD_CONFIG._RIO_CONFIG.INCLUDE_RMSG_NET.RMSG_NET_RX_BUF_SIZE {} 0 int
