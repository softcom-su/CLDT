...
public class ReferenceType extends Tag implements ICompositeType, IResolvableTag {

	Tag type;

	public ReferenceType(Tag prototype) {
		super(prototype);
	}

	public ReferenceType(ByteBuffer data) {
		super(DwarfConstants.DW_TAG_reference_type, data);
	}
	...
	public long getId() {
		if (type != null) {
			return ("ref:" + ((IType) type).getId()).hashCode();
		}
		return 0L;
	}
