...
public class TranslationPerspective implements IPerspectiveFactory {
	...
	/** Perspective ID. */
	public static final String ID = "su.softcom.cldt.ui.perspective.translation"; //$NON-NLS-1$
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		IFolderLayout navigation = layout.createFolder(ID_FOLDER_NAVIGATION, IPageLayout.LEFT, (float) 0.2, editorArea);
		if (isViewExist("su.softcom.cldt.meta.ui", "su.softcom.cldt.meta.ui.views.TranslationExplorer")) {
			navigation.addView("su.softcom.cldt.ui.views.translation");
		} else {
		...
		problems.addView("org.eclipse.ui.views.ProgressView"); //$NON-NLS-1$
	}
