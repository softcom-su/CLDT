...
/**
 * Class for build perspective factory
 *
 */
public class BuildPerspectiveFactory implements IPerspectiveFactory {

	/**
	 * Perspective ID
	 */
	public static final String ID = "su.softcom.cldt.ui.perspective.nativebuild"; //$NON-NLS-1$
	/**
	 * Left placeholder for navigating through solutions
	 */
	public static final String ID_FOLDER_NAVIGATION = ID + "folders.navigation";
	/**
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		if (isViewExist("su.softcom.cldt.meta.ui", "su.softcom.cldt.meta.ui.views.BuildExplorer")) {
			navigation.addView("su.softcom.cldt.ui.views.nativebuild");
		} else {
		...
		problems.addView("org.eclipse.ui.views.ProgressView");
	}
