...
/**
 * Class for load perspective factory
 *
 */
public class LoadPerspectiveFactory implements IPerspectiveFactory {

	/**
	 * Perspective ID
	 */
	public static final String ID = "su.softcom.cldt.ui.perspective.loadsolution"; //$NON-NLS-1$
	/**
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		if (isViewExist("su.softcom.cldt.meta.ui", "su.softcom.cldt.meta.ui.views.LoadExplorer")) {
			navigation.addView("su.softcom.cldt.ui.views.load");
		} else {
