...
#					Y[r] = 1
	...
	X += n
	if n: N += 1
print(sys.argv[0], " - синтаксический анализ свободных регистров".encode("utf-8"))
print(sys.argv[1], "==>", sys.argv[2])
print("Всего линейных участков      :".encode("utf-8"), L)
print("Из них с точками внедрения   :".encode("utf-8"), N)
print("Машинных команд (в участках) :".encode("utf-8"), C0)
print("Команд переходов             :".encode("utf-8"), C1)
print("Команд в слотах переходов    :".encode("utf-8"), C2)
print("Всего точек внедрения        :".encode("utf-8"), X)
print("Свободных регистров в точках внедрения :".encode("utf-8"), X2)
