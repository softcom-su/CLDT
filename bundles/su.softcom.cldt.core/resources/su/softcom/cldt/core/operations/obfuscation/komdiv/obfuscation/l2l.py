					...
					for n, f in enumerate(s[1]):
						for lm in LM:
							if lm == f:
								s[1][n] = S[i] + s[1][n]
								cor += 1
					if cor: F1[fun][lu]["txt"][j][k] = macjoin(s)
...
F2 = format_json(P)	# форматирование выходного файла
