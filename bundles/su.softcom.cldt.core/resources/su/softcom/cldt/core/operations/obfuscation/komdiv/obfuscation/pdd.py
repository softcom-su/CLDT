...
print(sys.argv[0], " - внедрение мертвых данных, файл".encode("utf-8"), sys.argv[2])
print(sys.argv[1], "==>", sys.argv[2])
print("Всего в исходном файле".encode("utf-8"))
print("       секций с данными :".encode("utf-8"), D0, DS)
print("       строк с данными  :".encode("utf-8"), D1)
print("       секций с мертвыми данными :".encode("utf-8"), D2, DDS)
print("       строк с мертвыми данными  :".encode("utf-8"), D3)
print("Добавлено при внедрении".encode("utf-8"))
print("    переменных в .bss  :".encode("utf-8"), D4)
print("         строк в .bss  :".encode("utf-8"), D5)
print("    переменных в .data :".encode("utf-8"), D6)
print("         строк в .data :".encode("utf-8"), D7)
